...
const ToggleBtnVariants = cva('flex items-center justify-center rounded-interactive-default', {
  variants: {
    size: {
      lg: 'py-2.5 px-3 gap-1.5 typo-body-base',
      md: 'py-2.5 px-3 gap-1.5 typo-callout-base',
    },
