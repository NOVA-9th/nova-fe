...
1. 기능 개발은 반드시 **feature** 및 **service** 브랜치에서 개발
2. 개발 완료 시 **dev** 브랜치로 병합
   - 브랜치명은 **camelCase** 를 사용한다. <br>
     ex) `feature/#1-loginPage`
3. 모든 QA 및 버그 수정 완료 시 **dev**으로 병합
...
### 1. 디자인 시스템 적용 및 공통 컴포넌트 구조 설계 문제
...
| 2차 스프린트 | ~2026-02-01 | - UI 및 구조 구현 <br/> - 컴포넌트 UI 구현 <br/> - 페이지 UI 구현 <br/> - API 연동 구조 준비 <br/> - 로딩 / 빈 상태 UI 연결 <br/> - 에러 처리 구현 | 진행중 |
| 2.5차 스프린트 | ~2026-02-07 | - API 연동 마무리 <br/> - 주요 API 연동 80% 완료 | 예정   |
| 3차 스프린트 | ~2026-02-15 | - 완성도 및 품질 개선 <br/> - UX 개선 <br/> - 예외 케이스 처리 <br/> - 콘솔 에러 제거 <br/> - 데모 시나리오 점검 <br/> - QA 반영 | 예정 |
